...
const GAME_LESSON_MOVES = [
  ...
  },
  {
    ...
    player: "White",
    explanation:
      "The c6 pawn threat meant nothing since after cxd5, Magnus simply responds with exd5, resulting in this position, which gives Magnus a winning position:",
    fen: "r1q4r/pp2pk1p/3pNnpB/3P4/8/2N4Q/PPP2PPP/R4RK1 b - - 0 16",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
  ...
  },
  {
    ...
    fen: "r3k2r/pp2pQ1p/3p1npB/3P2N1/6q1/2N5/PPP2PPP/R4RK1 b - - 6 19",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
    ...
    fen: "r6r/pp1kpQ1p/3p1npB/3P2N1/6q1/2N5/PPP2PPP/R4RK1 w - - 7 20",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
    ...
    fen: "r6r/pp1kpQ1p/3p1npB/3P2N1/6q1/2N5/PPP2PPP/4RRK1 b - - 8 20",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
    move: "26. Rae8",
    player: "Black",
    explanation: "Rainn plays Rae8",
    fen: "4r2r/pp1kpQ1p/3p1npB/3P2N1/6q1/2N5/PPP2PPP/4RRK1 w - - 9 21",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
    ...
    player: "White",
    explanation: "Nice!",
    fen: "4r2r/pp1kpQ1p/3pRnpB/3P2N1/6q1/2N5/PPP2PPP/5RK1 b - - 10 21",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
    move: "26. Qd4",
    player: "Black",
    explanation: "Rainn plays Qd4",
    fen: "4r2r/pp1kpQ1p/3pRnpB/3P2N1/3q4/2N5/PPP2PPP/5RK1 w - - 11 22",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
  ...
  },
  {
    move: "26. Ng4",
    player: "Black",
    explanation: "Rainn plays Ng4",
    fen: "4r2r/pp1kpQ1p/3pR1pB/3P2N1/3q2n1/2N5/PPP2PPP/4R1K1 w - - 13 23",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
  ...
  },
  {
    ...
    player: "White",
    explanation: "Nice! You're on the right track.",
    fen: "2k1R2r/pp3Q1p/3p2pB/3P2N1/3q2n1/2N5/PPP2PPP/6K1 b - - 2 25",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
    move: "35. Rxe8",
    player: "Black",
    explanation: "Rainn plays Rxe8.",
    fen: "2k1r3/pp3Q1p/3p2pB/3P2N1/3q2n1/2N5/PPP2PPP/6K1 w - - 0 26",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
  ...
  },
  {
    ...
    fen: "4Q3/ppk4p/3pN1pB/3P4/3q2n1/2N5/PPP2PPP/6K1 b - - 2 27",
    hint: "Push pawns to open lines for attack.",
    solution: "Black moved Ke8 to escape the check.",
  },
  {
