...
const STARTING_FEN =
  "3r2k1/2r2pb1/pp1N1np1/8/2P5/1P2B2P/P4PP1/2RR2K1 w - - 2 30"; // complete

const GAME_LESSON_MOVES = [
  {
    move: "1. Bxb6", // compleete
    player: "White",
    explanation:
  ...
  return (
    ...
    >
      ...
      {gameEnded && (
        ...
        >
          Pins and Skewers Lesson 3: Complete
          <div className="ButtonElements">
            <button
              onClick={() =>
                navigate("/lessons/beginner/pins_and_skewers_practice_4")
              }
            >
              Continue
            </button>
