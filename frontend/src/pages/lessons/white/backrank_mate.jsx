...
const STARTING_FEN = "6k1/5ppp/8/8/8/2BP2N1/5PP1/4R1K1 w - - 0 1"; // complete

const GAME_LESSON_MOVES = [
  {
    move: "1. Re8#", // compleete
    player: "White",
    explanation: "This checkmates the king on e8.",
    fen: "r2q1rk1/pb3ppp/1pnp1n2/2pPp3/2P1P3/1NPB4/P4PPP/R1BQ1RK1 w Qq - 0 1",
    hint: "Think about where the king is located at",
...
function hanging_pieces_practice() {
  ...
  const [feedback, setFeedback] = useState(
    "Practice: In this position, white can checkmate the king in one move. Can you find it?",
  );
...
export default hanging_pieces_practice;
