...
// You must wrap everything in the function named DistantOpposition
const DistantOpposition = () => {
  const navigate = useNavigate(); // This must be INSIDE the function

  return (
    <div>
      <h1>Distant Opposition</h1>
      <h2>What is Distant Opposition?</h2>
      <ul> {/* Added ul for proper HTML structure */}
...
export default DistantOpposition;