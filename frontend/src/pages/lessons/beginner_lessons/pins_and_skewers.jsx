...
import relativePinImage from "./relative_pins.png";
import absolutePinImage from "./absolute_pins.png";
import skewerImage from "./skewers.png";
  ...
  return (
    <div>
      ...
      <p>
        ...
        rook can move in this scenario.</p><p> Conversely, Image b represents an
        example of an absolute pin: the bishop on d5 is pinning the Queen on f7
        to the king on h8; the king can move, but the queen cannot leave the
        diagonal as it would expose the king to the bishop
      </p>
      ...
      <p>
        ...
        </p><p>In the example below, the bishop on h4 is skewering the king on e2 - the
      ...
      <div className="ButtonElements">
        <button
          onClick={() => navigate("/lessons/beginner/pins_and_skewers_practice")}
        >
          Start Practicing
        </button>
      </div>
