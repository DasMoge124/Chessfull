...
const STARTING_FEN =
  "r3k2r/ppb2ppp/2nqpn2/3p2B1/3P4/1NP2B1P/PP3PP1/R2Q1RK1 b kq - 7 12";

const INITIAL_SCENARIO =
  "In this position, White played a completely random move that ignores checkmate in ONE MOVE! How did Black punish white?";
const GAME_LESSON_MOVES = [
  {
    ...
    customIncorrectFeedback: {
      default:
        "This doesn't checkmate white. Now white has a slightly higher advantage.",
    },
  },
];
// =========================================================
